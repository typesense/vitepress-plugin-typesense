...
export default () =>
  ({
    ...
    typesenseServerConfig: {
      nodes: import.meta.env.VITE_PUBLIC_TYPESENSE_URLS
      ...
      nearestNode: {
        url:
          import.meta.env.VITE_PUBLIC_TYPESENSE_NEAREST_NODE_URL ||
          'http://localhost:8108',
      },
      apiKey:
        import.meta.env.VITE_PUBLIC_TYPESENSE_SEARCH_ONLY_API_KEY || 'xyz',
    },
